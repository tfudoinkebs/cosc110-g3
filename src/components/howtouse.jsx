    ...
    <div className="w-full p-4 pt-8 text-center font-mono text-sm md:w-4/5 lg:w-3/5">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option value="falsi">False Position (Regula Falsi)</option>
      ...
      {method === "bisection" || method === "falsi" ? (
        <>
          <p className="text-justify">
            1. Enter the{" "}
            <span className="font-semibold text-orange-500">equation</span> in
            the input field. The equation should be written in JavaScript
        ...
        <>
          ...
          <p className="text-justify">
            ...
            <span className="font-semibold text-orange-500">Xo</span>. This is
            your initial guess for the root of the equation.
          </p>{" "}
          <br />
          <p className="text-justify">
            3. Enter the{" "}
      ...
      <p className="text-justify">
        Click the "
        <span className="font-semibold text-orange-500">Calculate</span>" button
        to start the root finding process. The method will iterate until it
        finds a root that is within the specified error tolerance, or until it
        reaches the maximum number of iterations.
      </p>{" "}
      <br />
      <p className="text-justify">
        The results will be displayed in a table below the input fields. The
        table will show the iteration number, the current guess for the root,
        the value of the function at that guess, the value of the derivative at
        that guess, and the relative error.
      </p>{" "}
      <br />
      <p className="text-justify">
        If you want to reset the input fields and the results table, click the "
